		...
		<section id="featured-cars" class="featured-cars">
			<div class="container">
				<div class="section-header">
					<p>Auto-Stock<span> </span>Solutions</p>
					...
					<div class="row">
							...
							<div class="single-featured-cars">
								<div class="featured-img-box">
									<div class="featured-cars-img">
										<img src="assets/images/featured-cars/fc1.jpeg" alt="cars">
									</div>
						...
						<div class="col-lg-3 col-md-4 col-sm-6">
							<div class="single-featured-cars">
								<div class="featured-img-box">
									<div class="featured-cars-img">
										<img src="assets/images/featured-cars/fc2.jpg" alt="cars">
									</div>
									<div class="featured-model-info">
										<p>
											Modelo 2024
						...
						<div class="col-lg-3 col-md-4 col-sm-6">
							<div class="single-featured-cars">
								<div class="featured-img-box">
									<div class="featured-cars-img">
										<img src="assets/images/featured-cars/fc3.jpg" alt="cars">
									</div>
									<div class="featured-model-info">
										<p>
											Modelo 2018
						...
						<div class="col-lg-3 col-md-4 col-sm-6">
							<div class="single-featured-cars">
								<div class="featured-img-box">
									<div class="featured-cars-img">
										<img src="assets/images/featured-cars/fc4.jpg" alt="cars">
									</div>
									<div class="featured-model-info">
										<p>
											Modelo 2017
					...
					<div class="row">
						<div class="col-lg-3 col-md-4 col-sm-6">
							<div class="single-featured-cars">
								<div class="featured-img-box">
									<div class="featured-cars-img">
										<img src="assets\images\featured-cars\fc5.jpg" alt="cars">
									</div>
									<div class="featured-model-info">
										<p>
											Modelo 2024
											<span class="featured-mi-span">Clase GTI </span> 
											<span class="featured-hp-span"> </span>
											 Automatico
										</p>
									</div>
						...
						<div class="col-lg-3 col-md-4 col-sm-6">
							<div class="single-featured-cars">
								<div class="featured-img-box">
									<div class="featured-cars-img">
										<img src="assets/images/featured-cars/fc6.jpg" alt="cars">
									</div>
									<div class="featured-model-info">
										<p>
											Modelo 2023
						...
						<div class="col-lg-3 col-md-4 col-sm-6">
							<div class="single-featured-cars">
								<div class="featured-img-box">
									<div class="featured-cars-img">
										<img src="assets/images/featured-cars/fc7.jpg" alt="cars">
									</div>
									<div class="featured-model-info">
										<p>
											Modelo 2023
											<span class="featured-mi-span"> Clase GLI</span> 
											<span class="featured-hp-span"></span>
											 Automatico
										</p>
									</div>
						...
						<div class="col-lg-3 col-md-4 col-sm-6">
							<div class="single-featured-cars">
								<div class="featured-img-box">
									<div class="featured-cars-img">
										<img src="assets/images/featured-cars/fc8.jpg" alt="cars">
									</div>
									<div class="featured-model-info">
										<p>
											Modelo 2023
